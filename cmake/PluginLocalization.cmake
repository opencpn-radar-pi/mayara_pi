...
foreach (POTLINE IN ITEMS ${HDRS})
  file(APPEND ${POTFILE}.test "${POTLINE}\n")
endforeach (POTLINE)
# The server's schema text (control names, enum labels): generated by
# tools/gen-server-strings.py, read only by xgettext. See include/ServerText.h.
if (EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/po/server_strings.h)
  file(APPEND ${POTFILE}.test "po/server_strings.h\n")
endif ()
...
if (GETTEXT_XGETTEXT_EXECUTABLE)
  add_custom_command(
    ...
    COMMAND
      ...
      --output=po/${PACKAGE_NAME}.pot --keyword=_ --keyword=wxTRANSLATE
      --keyword=wxTRANSLATE_IN_CONTEXT:1c,2 --width=80
